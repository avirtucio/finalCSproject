...
from models.User_Model import User_Model  # If you have this already
...
# Register Clothes controller blueprint
app.register_blueprint(clothes_bp, url_prefix='/clothes')

def bootstrap_database():
    Clothes_Model.initialize_DB(DB_PATH)
    User_Model.initialize_DB(DB_PATH)  # Add others like Closet_Model, etc.
